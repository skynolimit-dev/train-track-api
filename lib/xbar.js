    ...
    if (!departures || departures.length === 0) {
        ...
        for (const departure of departures.slice(0, maxDepartures)) {
            ...
            // If no cancellation, get any delay information
                ...
                dropdownOutput += getDropdownOutput(fromStation, toStation, departure);
            }
        }
    }
...
function getDropdownOutput(fromStation, toStation, departure) {
    ...
    return `${bookedDepartureTime} (actual: ${realtimeDepartureTime}) ${fromStationName} to ${toStationName} - Platform ${platform} | href=https://departureboard.io/journey/${fromStation}/${toStation}/ \n`;
}
